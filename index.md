...
<div class="not-prose mt-8 max-w-xl">
  <p class="text-lg text-stone-600">Install the Studio Mac app (.dmg). The button downloads <strong class="font-medium text-stone-800">Studio-mac.dmg</strong> from the public <strong class="font-medium text-stone-800">studio-pages</strong> GitHub Release (anonymous visitors cannot download installers from Releases on private repos).</p>
